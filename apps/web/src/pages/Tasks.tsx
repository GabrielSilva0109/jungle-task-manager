  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">Tarefas</h1>
          <p className="text-gray-400 text-sm sm:text-base">Gerencie todas as suas tarefas</p>
        </div>
      ...
      <div className="space-y-4">
        {filteredTasks.map((task) => (
          <StandardCard key={task.id}>
            <div className="space-y-4">
              {/* Header da tarefa - título e badges */}
              ...
              <div className="flex sm:hidden gap-2 pt-2 border-t border-gray-700">
                <div className="flex-1">
                  <label className="text-xs text-gray-400 block mb-1">Status</label>
                  <select
                    value={task.status}
                    onChange={(e) => handleStatusChange(task.id, e.target.value as 'Pendente' | 'Em Progresso' | 'Concluída')}
                    className="w-full bg-gray-800 border-gray-700 text-white rounded px-3 py-2 text-sm"
                  >
                    <option value="Pendente">Pendente</option>
                    <option value="Em Progresso">Em Progresso</option>
                    <option value="Concluída">Concluída</option>
